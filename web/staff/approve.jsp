...
<table>
    ...
    <c:forEach items="${ros}" var="r">
        <tr>
            ...
            <td><a href="${pageContext.request.contextPath}/fow/"></a>请求换班</td>
            <td><a href="${pageContext.request.contextPath}/staff/askLeave.jsp?id=${personalData.id}&time=${r.time}"></a>请假</td>
        </tr>
    </c:forEach>
</table>
----------------我的历史更改请求-----------------
